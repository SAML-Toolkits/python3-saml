...
class Saml2_Logout_Request_Test(unittest.TestCase):
    ...
    def assertRegex(self, text, regexp, msg=None):
        if hasattr(unittest.TestCase, "assertRegex"):
            return super(Saml2_Logout_Request_Test, self).assertRegex(text, regexp, msg)
        else:
    ...
    def assertRaisesRegex(self, exception, regexp, msg=None):
        if hasattr(unittest.TestCase, "assertRaisesRegex"):
            return super(Saml2_Logout_Request_Test, self).assertRaisesRegex(
    ...
    def testConstructor(self):
        ...
        self.assertRegex(
            logout_url, r"^http://idp\.example\.com\/SingleLogoutService\.php\?SAMLRequest="
        )
    ...
    def testConstructorWithNameIdFormatOnSettings(self):
        ...
        """
        settings_info = self.loadSettingsJSON()
        name_id = "1e442c129e1f822c8096086a1103c5ee2c7cae1c"
        name_id_format = "urn:oasis:names:tc:SAML:2.0:nameid-format:transient"
        settings_info["sp"]["NameIDFormat"] = name_id_format
        settings = Saml2_Settings(settings_info)
        logout_request = Saml2_Logout_Request(settings, name_id=name_id)
        logout_request_xml = Saml2_Utils.decode_base64_and_inflate(logout_request.get_request())
        name_id_data = Saml2_Logout_Request.get_nameid_data(logout_request_xml)
    ...
    def testGetNameIdData(self):
        ...
        name_id_data_2 = Saml2_Logout_Request.get_nameid_data(dom.toxml())
        ...
        logout_request = Saml2_Logout_Request(
            settings,
            None,
            expected_name_id_data["Value"],
            None,
            idp_data["entityId"],
            expected_name_id_data["Format"],
        )
        name_id_data_3 = Saml2_Logout_Request.get_nameid_data(logout_request.get_xml())
        ...
        name_id_data_4 = Saml2_Logout_Request.get_nameid_data(logout_request.get_xml())
        self.assertEqual(expected_name_id_data, name_id_data_4)
        ...
        logout_request = Saml2_Logout_Request(settings)
        name_id_data_5 = Saml2_Logout_Request.get_nameid_data(logout_request.get_xml())
    ...
    def testGetIssuer(self):
        ...
        dom = parseString(request)
        issuer_2 = Saml2_Logout_Request.get_issuer(dom.toxml())
        ...
        issuer_3 = Saml2_Logout_Request.get_issuer(dom.toxml())
    ...
    def testGetSessionIndexes(self):
        ...
        dom = parseString(request)
        session_indexes_2 = Saml2_Logout_Request.get_session_indexes(dom.toxml())
    ...
    def testIsInvalidXML(self):
        ...
        Case Invalid XML
        """
        request = Saml2_Utils.b64encode("<xml>invalid</xml>")
        request_data = {
        ...
        logout_request = Saml2_Logout_Request(settings, request)

        self.assertTrue(logout_request.is_valid(request_data))

        settings.set_strict(True)
        logout_request2 = Saml2_Logout_Request(settings, request)
    ...
    def testIsInvalidIssuer(self):
        ...
        settings.set_strict(True)
        logout_request2 = Saml2_Logout_Request(settings, Saml2_Utils.b64encode(request))
    ...
    def testIsInvalidDestination(self):
        ...
        logout_request3 = Saml2_Logout_Request(settings, Saml2_Utils.b64encode(dom.toxml()))
        self.assertTrue(logout_request3.is_valid(request_data))

        dom.documentElement.removeAttribute("Destination")
        logout_request4 = Saml2_Logout_Request(settings, Saml2_Utils.b64encode(dom.toxml()))
    ...
    def testIsValid(self):
        ...
        current_url = Saml2_Utils.get_self_url_no_query(request_data)
        request = request.replace("http://stuff.com/endpoints/endpoints/sls.php", current_url)
        logout_request5 = Saml2_Logout_Request(settings, Saml2_Utils.b64encode(request))
    ...
    def testIsValidWithCapitalization(self):
        ...
        request = request.replace(
            "http://stuff.com/endpoints/endpoints/sls.php", current_url.lower()
        )
        logout_request5 = Saml2_Logout_Request(settings, Saml2_Utils.b64encode(request))
        self.assertTrue(logout_request5.is_valid(request_data))
    ...
    def testGetXML(self):
        ...
        logout_request_processed = Saml2_Logout_Request(settings, Saml2_Utils.b64encode(request))
