...
class Saml2_Settings_Test(unittest.TestCase):
    ...
    def testLoadSettingsFromInvalidData(self):
        ...
        try:
            Saml2_Settings(invalid_settings)
    ...
    def testGetLibPath(self):
        """
        Tests getLibPath method of the Saml2_Settings
        """
    ...
    def testGetSchemasPath(self):
        """
        Tests getSchemasPath method of the Saml2_Settings
        """
        settingsInfo = self.loadSettingsJSON()
        settings = Saml2_Settings(settingsInfo)
        path = settings.get_base_path()
    ...
    def testGetIdPSSOurl(self):
        """
        Tests the get_idp_sso_url method of the Saml2_Settings class
        """
        settings_info = self.loadSettingsJSON()
        settings = Saml2_Settings(settings_info)
    ...
    def testGetIdPSLOurl(self):
        """
        Tests the get_idp_slo_url method of the Saml2_Settings class
        """
        settings_info = self.loadSettingsJSON()
        settings = Saml2_Settings(settings_info)
    ...
    def testGetIdPSLOresponseUrl(self):
        """
        Tests the get_idp_slo_response_url method of the Saml2_Settings class
        """
        settings_info = self.loadSettingsJSON()
    ...
    def testGetSPCert(self):
        """
        Tests the get_sp_cert method of the Saml2_Settings
        """
    ...
    def testGetSPCertNew(self):
        """
        Tests the get_sp_cert_new method of the Saml2_Settings
        """
        settings_data = self.loadSettingsJSON()
        cert = "-----BEGIN CERTIFICATE-----\\nQ4/67OZfHd7R+POBXhophSMv1ZOo\n-----END CERTIFICATE-----\n"
        settings = Saml2_Settings(settings_data)
        ...
        settings = Saml2_Settings(self.loadSettingsJSON("settings7.json"))
    ...
    def testGetSPKey(self):
        """
        Tests the get_sp_key method of the Saml2_Settings
        """
        settings_data = self.loadSettingsJSON()
        ...
        settings_2 = Saml2_Settings(settings_data)
    ...
    def testGetIDPCert(self):
        """
        Tests the get_idp_cert method of the Saml2_Settings
        """

        settings = Saml2_Settings(self.loadSettingsJSON("settings9.json"))
        cert = "-----BEGIN CERTIFICATE-----\\nQ4/67OZfHd7R+POBXhophSMv1ZOo\n-----END CERTIFICATE-----"
    ...
    def testFormatIdPCert(self):
        """
        Tests the format_idp_cert method of the Saml2_Settings
        """
        settings_data = self.loadSettingsJSON()
        cert = "-----BEGIN CERTIFICATE-----\\nQ4/67OZfHd7R+POBXhophSMv1ZOo\n-----END CERTIFICATE-----\n"
        settings = Saml2_Settings(settings_data)
    ...
    def testFormatSPCert(self):
        """
        Tests the format_sp_cert method of the Saml2_Settings
        """
        settings_data = self.loadSettingsJSON()
    ...
    def testFormatSPKey(self):
        """
        Tests the format_sp_key method of the Saml2_Settings
        """
        settings_data = self.loadSettingsJSON()
        key = "-----BEGIN RSA PRIVATE KEY-----\\n-----END RSA PRIVATE KEY-----\n"
    ...
    def testCheckSPCerts(self):
        """
        Tests the checkSPCerts method of the Saml2_Settings
        """
    ...
    def testCheckSettings(self):
        """
        Tests the checkSettings method of the Saml2_Settings
        The checkSettings method is private and is used at the constructor
        """
        settings_info = {}
        try:
            Saml2_Settings(settings_info)
            self.assertTrue(False)
        except Exception as e:
        ...
        try:
            ...
            self.assertIn(
                "sp_attributeConsumingService_requestedAttributes_isRequired_type_invalid", str(e)
            )
        ...
        settings_info["contactPerson"] = {
            ...
            "auxiliar": {"givenName": "auxiliar_name", "emailAddress": "auxiliar@example.com"},
        }
        try:
            Saml2_Settings(settings_info)
            self.assertTrue(False)
    ...
    def testGetSPMetadata(self):
        """
        Tests the getSPMetadata method of the Saml2_Settings
    ...
    def testGetSPMetadataSigned(self):
        ...
        with self.assertRaises(Saml2_Error):
    ...
    def generateAndCheckMetadata(self, settings):
        ...
        """
        if not isinstance(settings, Saml2_Settings):
    ...
    def testGetSPMetadataSignedNoMetadataCert(self):
        ...
        with self.assertRaises(Exception) as context:
            ...
            exception = context.exception
            self.assertIn(
                "Invalid Setting: signMetadata value of the sp is not valid", str(exception)
            )

    def testValidateMetadata(self):
        """
        Tests the validateMetadata method of the Saml2_Settings
        Case valid metadata
        """
        settings = Saml2_Settings(self.loadSettingsJSON())
    ...
    def testGetIdPData(self):
        """
        Tests the getIdPData method of the Saml2_Settings
        """
        settings = Saml2_Settings(self.loadSettingsJSON())
        ...
        self.assertEqual(
            "http://idp.example.com/SSOService.php", idp_data["singleSignOnService"]["url"]
        )
        self.assertEqual(
            "http://idp.example.com/SingleLogoutService.php", idp_data["singleLogoutService"]["url"]
        )
        ...
        formated_x509_cert = Saml2_Utils.format_cert(x509cert)
        self.assertEqual(formated_x509_cert, idp_data["x509cert"])

    def testGetSPData(self):
        """
        Tests the getSPData method of the Saml2_Settings
        """
        settings = Saml2_Settings(self.loadSettingsJSON())
        ...
        self.assertEqual(
            "http://stuff.com/endpoints/endpoints/sls.php", sp_data["singleLogoutService"]["url"]
        )
        self.assertEqual(
    ...
    def testGetSecurityData(self):
        """
        Tests the getSecurityData method of the Saml2_Settings
        """
        settings = Saml2_Settings(self.loadSettingsJSON())
    ...
    def testGetDefaultSecurityValues(self):
        ...
        settings = Saml2_Settings(settings_json)
        security = settings.get_security_data()
    ...
    def testGetContacts(self):
        """
        Tests the getContacts method of the Saml2_Settings
        """
        settings = Saml2_Settings(self.loadSettingsJSON())
    ...
    def testGetOrganization(self):
        """
        Tests the getOrganization method of the Saml2_Settings
        """
        settings = Saml2_Settings(self.loadSettingsJSON())
    ...
    def testSetStrict(self):
        """
        Tests the setStrict method of the Saml2_Settings
        """
        settings = Saml2_Settings(self.loadSettingsJSON())
    ...
    def testIsStrict(self):
        """
        Tests the isStrict method of the Saml2_Settings
        """
        settings_info = self.loadSettingsJSON()
    ...
    def testIsDebugActive(self):
        """
        Tests the isDebugActive method of the Saml2_Settings
        """
        settings_info = self.loadSettingsJSON()
