...
class OneLogin_Saml2_Settings_Test(unittest.TestCase):
    ...
    def testGetLibPath(self):
        ...
        self.assertEqual(
            ...
            join(dirname(dirname(dirname(dirname(dirname(__file__))))), "src/onelogin/saml2/"),
        )
        self.assertEqual(
            path,
            join(
                dirname(dirname(dirname(dirname(dirname(__file__))))),
                "src/onelogin/saml2/../../../tests/data/customPath/",
            ),
        )
    ...
    def testGetSchemasPath(self):
        ...
        self.assertEqual(
            ...
            join(
                dirname(dirname(dirname(dirname(dirname(__file__))))), "src/onelogin/saml2/schemas/"
            ),
        )
        self.assertEqual(
            path,
