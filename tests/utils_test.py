...
class OneLogin_Saml2_Utils_Test(unittest.TestCase):
    ...
    def assertRaisesRegex(self, exception, regexp, msg=None):
        if hasattr(unittest.TestCase, "assertRaisesRegex"):
            return super(OneLogin_Saml2_Utils_Test, self).assertRaisesRegex(
    ...
    def testGetSelfURLhost(self):
        ...
        self.assertEqual(
            "http://example.com:81", OneLogin_Saml2_Utils.get_self_url_host(request_data)
        )
        ...
        self.assertEqual(
            "https://example.com:444", OneLogin_Saml2_Utils.get_self_url_host(request_data)
        )
    ...
    def testGetSelfURL(self):
        ...
        self.assertEqual(
            url + "/test/index.html?testing", OneLogin_Saml2_Utils.get_self_url(request_data)
        )
    ...
    def testGetExpireTime(self):
        ...
        self.assertEqual(
            "1291955971", OneLogin_Saml2_Utils.get_expire_time("PT360000S", "2010-12-10T04:39:31Z")
        )
        self.assertEqual(
        ...
        self.assertNotEqual(
            "3311642371", OneLogin_Saml2_Utils.get_expire_time("PT360000S", "2074-12-10T04:39:31Z")
        )
        self.assertNotEqual(
    ...
    def testGenerateNameIdWithSPNameQualifier(self):
        ...
        name_id_enc = OneLogin_Saml2_Utils.generate_name_id(
            name_id_value, entity_id, name_id_format, key
        )
    ...
    def testGenerateNameIdWithoutSPNameQualifier(self):
        ...
        name_id_enc = OneLogin_Saml2_Utils.generate_name_id(
            name_id_value, None, name_id_format, key
        )
        expected_name_id_enc = '<saml:EncryptedID><xenc:EncryptedData xmlns:xenc="http://www.w3.org/2001/04/xmlenc#" xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion" Type="http://www.w3.org/2001/04/xmlenc#Element">\n<xenc:EncryptionMethod Algorithm="http://www.w3.org/2001/04/xmlenc#aes128-cbc"/>\n<dsig:KeyInfo xmlns:dsig="http://www.w3.org/2000/09/xmldsig#">\n<xenc:EncryptedKey>\n<xenc:EncryptionMethod Algorithm="http://www.w3.org/2001/04/xmlenc#rsa-oaep-mgf1p"/>\n<xenc:CipherData>\n<xenc:CipherValue>'
        self.assertIn(expected_name_id_enc, name_id_enc)
    ...
    def testCalculateX509Fingerprint(self):
        ...
        self.assertEqual(
            "afe71c28ef740bc87425be13a2263d37971da1f9",
            OneLogin_Saml2_Utils.calculate_x509_fingerprint(cert, "sha1"),
        )

        self.assertEqual(
            "c51cfa06c7a49767f6eab18238eae1c56708e29264da3d11f538a12cd2c357ba",
            OneLogin_Saml2_Utils.calculate_x509_fingerprint(cert, "sha256"),
        )

        self.assertEqual(
            "bc5826e6f9429247254bae5e3c650e6968a36a62d23075eb168134978d88600559c10830c28711b2c29c7947c0c2eb1d",
            OneLogin_Saml2_Utils.calculate_x509_fingerprint(cert, "sha384"),
        )
    ...
    def testFormatFingerPrint(self):
        ...
        self.assertEqual(
            "afe71c28ef740bc87425be13a2263d37971da1f9",
            OneLogin_Saml2_Utils.format_finger_print(finger_print_2),
        )
    ...
    def testDecryptElementInplace(self):
        ...
        encrypted_node = dom.xpath(
            "//saml:EncryptedID/xenc:EncryptedData", namespaces=OneLogin_Saml2_Constants.NSMAP
        )[0]

        # can be decrypted twice when copy the node first
        for _ in range(2):
            decrypted_nameid = OneLogin_Saml2_Utils.decrypt_element(
                encrypted_node, key, inplace=False
            )
    ...
    def testValidateSign(self):
        ...
        self.assertFalse(
            OneLogin_Saml2_Utils.validate_metadata_sign(
                xml_metadata_signed, cert, validatecert=True
            )
        )
        ...
        self.assertTrue(
            OneLogin_Saml2_Utils.validate_metadata_sign(xml_metadata_signed_2, None, fingerprint_2)
        )
        ...
        # expired cert, verified it
        self.assertFalse(
            OneLogin_Saml2_Utils.validate_sign(xml_response_msg_signed, cert, validatecert=True)
        )
        ...
        self.assertFalse(
            OneLogin_Saml2_Utils.validate_sign(xml_response_msg_signed, cert_x, validatecert=True)
        )
        ...
        self.assertTrue(
            OneLogin_Saml2_Utils.validate_sign(xml_response_msg_signed_2, None, fingerprint_2)
        )
        self.assertTrue(
            OneLogin_Saml2_Utils.validate_sign(
                xml_response_msg_signed_2, None, fingerprint_2, "sha1"
            )
        )
        self.assertTrue(
            OneLogin_Saml2_Utils.validate_sign(
                xml_response_msg_signed_2, None, fingerprint_2_256, "sha256"
            )
        )
        ...
        # expired cert, verified it
        self.assertFalse(
            OneLogin_Saml2_Utils.validate_sign(xml_response_assert_signed, cert, validatecert=True)
        )
        ...
        self.assertTrue(
            OneLogin_Saml2_Utils.validate_sign(xml_response_assert_signed_2, None, fingerprint_2)
        )
        ...
        # expired cert, verified it
        self.assertFalse(
            OneLogin_Saml2_Utils.validate_sign(xml_response_double_signed, cert, validatecert=True)
        )
        ...
        self.assertTrue(
            OneLogin_Saml2_Utils.validate_sign(xml_response_double_signed_2, None, fingerprint_2)
        )
        ...
        assert_elem_3.setAttributeNS(
            OneLogin_Saml2_Constants.NS_SAML, "xmlns:saml", OneLogin_Saml2_Constants.NS_SAML
        )
